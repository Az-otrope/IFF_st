...
def data_cleaning(df):
    ...
    INPUT: a dataframe containing original historical data
    ...
    try:
        df.drop(['Storage tracking', 'Seed treatment', 'Ingredient4', 'Yield (%)', 'Log loss', 'Note'],
                axis=1, inplace=True)
    except:
        pass
...
def sample_info_app():
    ...
    # =============================================================================
           st.write(df_v1)
           st.session_state.df = df_v1 # this will be the sample_info df in the database
